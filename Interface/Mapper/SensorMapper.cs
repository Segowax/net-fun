...
namespace Interface.Mapper
{
    public static class SensorMapper
    {
        ...
        public static StringSensorDataDto MapToStringSensorDataDto(this SensorData sensorData)
        {
            return new StringSensorDataDto(
                sensorId: sensorData.SensorId,
                name: sensorData.Name,
        ...
        public static BooleanSensorDataDto? MapToBooleanSensorDataDto(this SensorData sensorData)
        {
            if (bool.TryParse(sensorData.Value, out bool boolResult))
            {
                return new BooleanSensorDataDto(
                    sensorId: sensorData.SensorId,
                    name: sensorData.Name,
